...
class ConfusionMatrix:
    ...
    def plot(self, normalize=True, save_dir="", names=()):
        ...
        with warnings.catch_warnings():
            ...
            sn.heatmap(array, ax=ax, annot=nc < 30, annot_kws={"size": 8}, cmap="Blues", fmt=".2f", square=True, vmin=0.0, xticklabels=ticklabels, yticklabels=ticklabels).set_facecolor((1, 1, 1))
        ax.set_ylabel("True")
