...
# TODO: split to some methods
# TODO: apply to pred mode
def main():
    category = "aircraft"
    # category = sys.argv[1]
    ...
    for i, (entity_id, qas) in tqdm(enumerate(entity_to_qas.items())):
    ...
    entity_to_qas_bem_path = entity_to_qas_path.split(".json")[0] + "_bem.json"
